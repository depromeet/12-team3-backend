...
==== Method : PATCH
==== curl-request
include::{snippets}/modify-template/curl-request.adoc[]
include::{snippets}/modify-template/request-fields.adoc[]
==== Request Body
include::{snippets}/modify-template/request-body.adoc[]
==== Response Body
include::{snippets}/modify-template/response-fields.adoc[]
==== 정상 응답 - 정상
include::{snippets}/modify-template/response-body.adoc[]
...
include::{snippets}/template-delete-item/path-parameters.adoc[]
...
==== Request Body
include::{snippets}/template-modfiy-item/request-body.adoc[]
==== 정상 응답 - 정상
