...
==== 에러 응답 - 카테고리 이름의 길이가 10글자 초과
include::{snippets}/category-name-length-error/request-fields.adoc[]
include::{snippets}/category-name-length-error/response-fields.adoc[]
include::{snippets}/category-name-length-error/response-body.adoc[]
...
==== 에러 응답 - 카테고리 작성자와 수정 이용자가 다를 경우
include::{snippets}/category-modify-error/request-headers.adoc[]
include::{snippets}/category-modify-error/response-body.adoc[]
include::{snippets}/category-modify-error/response-fields.adoc[]
