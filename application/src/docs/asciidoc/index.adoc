...
==== Request Body
include::{snippets}/modify-template-pin/request-body.adoc[]
==== Response Body
include::{snippets}/modify-template-pin/response-fields.adoc[]
==== 정상 응답 - 정상
...
==== Request Body
include::{snippets}/modify-template-name/request-body.adoc[]
==== Response Body
include::{snippets}/modify-template-name/response-fields.adoc[]
==== 정상 응답 - 정상
